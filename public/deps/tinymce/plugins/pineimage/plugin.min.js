...
tinymce.PluginManager.add('pineimage', function(editor) {
    ...
    function showDialog(imageList) {
        ...
        function buildImageList() {
            ...
            tinymce.each(imageList, function(image) {
                var it = image.value;
                var path = window.location.search.replace('index.md', '').replace('?path=pineneedles/contents/', '//support.sugarcrm.com/');
                var fullSrc = path + it;
                
                imageListItems.push({
                    text: image.text || image.title,
                    value: editor.convertURL(fullSrc || image.url, 'src'),
                    menu: image.menu
                });
            });
